        ...
        <v-col v-else cols="11" class="mx-auto">
          <v-row>
            <v-col cols="12" sm="12" md="8" lg="8">
                ...
                <div ref="hello">
                  ...
                  <v-card flat tile class="card">
                    ...
                    >
                      ...
                      >
                        {{ video.views }} Vistas<v-icon>mdi-circle-small</v-icon
                    ...
                    <v-col cols="12" sm="6" md="4" lg="4">
                      ...
                      >
                        <v-btn
                          ...
                          @click="subscribe"
                          >{{ !subscribed ? 'Subscribirse' : 'Subscrito' }}</v-btn
                        >
              ...
              <v-row>
                <v-col v-if="video && video.status === 'public'">
                  <p class="mb-0">{{ video.comments }} Comentarios</p>
            ...
            <v-col cols="12" sm="12" md="4" lg="4">
              <hr class="grey--text" />
              <h4 class="mb-3 mt-3">Siguiente</h4>
              <div
