      ...
      <v-tab-item>
        <template>
          <v-card flat>
            ...
            <v-data-table
              no-data-text="No hay vídeos disponibles, por favor sube el vídeo."
              :headers="headers"
              :items="videos"
              :search="search"
              :loading="loading"
              ...
              <template v-slot:top>
                <v-dialog v-model="dialogDelete" persistent max-width="500px">
                  <v-card>
                    <v-card-title>
                      <span class="headline"
                        >¿Deseas eliminar el video permanentemente?</span
                      >
                    </v-card-title>
