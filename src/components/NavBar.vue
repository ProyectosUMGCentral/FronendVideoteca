      ...
      <v-menu offsetY>
        <template v-slot:activator="{ on: menu }">
          <v-tooltip bottom>
            ...
            <span>Carga uno o mas videos</span>
          </v-tooltip>
        </template>
        <v-list>
          <v-list-item router to="/studio">
            ...
            >
            <v-list-item-title>Cargar video</v-list-item-title>
          </v-list-item>
          <!-- <v-list-item>
            <v-list-item-icon class="mr-3"
        ...
        <v-card>
          ...
          <v-list>
            ...
            >
              ...
              <v-list-item-title>Tu cuenta</v-list-item-title>
            </v-list-item>
            <v-list-item router to="/studio">
              <v-list-item-icon>
                <v-icon>mdi-youtube-studio</v-icon>
              </v-list-item-icon>
              <v-list-item-title>MyDaFa Studio</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
              ...
              class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">MyDaFa</v-toolbar-title>
          </v-list-item>
